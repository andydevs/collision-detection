...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/**\n * Collision detection\n * \n * Author:  Anshul Kharbanda\n * Created: 4 - 30 - 2021\n */\n* {\n  font-family: 'Segoe UI',  Tahoma, Geneva,  Verdana, sans-serif; }\n\nbody {\n  margin: 0;\n  background-color: #333;\n  color: white; }\n\na {\n  color: #00aaff;\n  text-decoration: none; }\n\na::before {\n  content: '>'; }\n\n#app {\n  text-align: center;\n  padding: 4pt; }\n\n#grid {\n  display: grid;\n  place-items: center;\n  max-width: 1280px;\n  margin: auto;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: repeat(2, auto);\n  grid-template-areas: \"canvas canvas\" \"stats controls\"; }\n  @media screen and (max-width: 450px) {\n    #grid {\n      grid-template-columns: 1fr;\n      grid-template-areas: \"canvas\" \"stats\" \"controls\"; } }\n\n#canvas {\n  width: 100%;\n  border: 1px solid #777;\n  grid-area: canvas; }\n", "",{"version":3,"sources":["webpack://./app/style/main.scss"],"names":[],"mappings":"AAAA;;;;;EAKE;AACF;EACI,8DAEuB,EAAA;;AAG3B;EACI,SAAS;EACT,sBAAsB;EACtB,YAAY,EAAA;;AAGhB;EACI,cAAc;EACd,qBAAqB,EAAA;;AAEzB;EACI,YAAY,EAAA;;AAGhB;EACI,kBAAkB;EAClB,YAAY,EAAA;;AAGhB;EACI,aAAa;EACb,mBAAmB;EACnB,iBAAiB;EACjB,YAAY;EACZ,qCAAqC;EACrC,mCAAmC;EACnC,qDAEoB,EAAA;EACpB;IAVJ;MAWQ,0BAA0B;MAC1B,gDAGc,EAAA,EAErB;;AAED;EACI,WAAW;EACX,sBAAsB;EACtB,iBAAiB,EAAA","sourcesContent":["/**\n * Collision detection\n * \n * Author:  Anshul Kharbanda\n * Created: 4 - 30 - 2021\n */\n* {\n    font-family: 'Segoe UI', \n        Tahoma, Geneva, \n        Verdana, sans-serif;\n}\n\nbody {\n    margin: 0;\n    background-color: #333;\n    color: white;\n}\n\na {\n    color: #00aaff;\n    text-decoration: none;\n}\na::before {\n    content: '>';\n}\n\n#app {\n    text-align: center;\n    padding: 4pt;\n}\n\n#grid {\n    display: grid;\n    place-items: center;\n    max-width: 1280px;\n    margin: auto;\n    grid-template-columns: repeat(2, 1fr);\n    grid-template-rows: repeat(2, auto);\n    grid-template-areas: \n        \"canvas canvas\"\n        \"stats controls\";\n    @media screen and (max-width: 450px) {\n        grid-template-columns: 1fr;\n        grid-template-areas: \n            \"canvas\"\n            \"stats\"\n            \"controls\";\n    }\n}\n\n#canvas {\n    width: 100%;\n    border: 1px solid #777;\n    grid-area: canvas;\n} "],"sourceRoot":""}]);
// Exports
